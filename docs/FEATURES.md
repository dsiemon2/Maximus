# Maximus Pet Store (MPS) - Feature Documentation

## Overview

This document describes all the features implemented in the Maximus Pet Store (MPS) e-commerce platform.
...
```bash
# For Maximus (using Docker)
docker-compose exec api php artisan migrate

# Or directly
cd maximus-backendadmin-api
php artisan migrate
```
...
- `http://localhost:8400/api/documentation`
