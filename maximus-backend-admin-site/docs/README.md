...
### Admin Pages
- **Dashboard**: http://localhost:8401/adminpanel/dashboard
- **Products**: http://localhost:8401/adminpanel/products
- **Orders**: http://localhost:8401/adminpanel/orders
- **Inventory**: http://localhost:8401/adminpanel/inventory
- **Customers**: http://localhost:8401/adminpanel/customers
- **Profile**: http://localhost:8401/adminpanel/profile
- **Settings**: http://localhost:8401/adminpanel/settings
