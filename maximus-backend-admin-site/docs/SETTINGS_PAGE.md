...
**URL**: `http://localhost:8401/adminpanel/settings`
...
The preview uses the current PRT logo:
```
http://localhost:8400/assets/images/MaximusLogo.png
```
...
2. Verify API server is running (port 8400)
