...
$apiBaseUrl = rtrim(env('API_BASE_URL', 'http://localhost:8000/api/v1'), '/');
...
$storeName = 'Maximus Pet Store'; // Default
$storeNameColor = '#2E86AB'; // Default pet store blue
...
<main class="main-content">
    ...
    <header class="top-header">
        ...
        <div class="header-right">
            <a href="{{ env('STOREFRONT_URL', 'http://localhost:8400') }}" class="header-icon" title="View Store" target="_blank">
