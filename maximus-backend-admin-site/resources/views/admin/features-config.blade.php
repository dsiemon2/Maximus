                            ...
                            <div class="border rounded p-3 mb-3" id="squareSection">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        ...
                                        <small class="text-muted">Cards + Square Wallet + Afterpay - <a href="https://squareup.com" target="_blank">squareup.com</a></small>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="feature_square_enabled" name="square_enabled" style="width: 3em; height: 1.5em;">
                                    </div>
                                </div>
                                <div class="row g-2" id="squareFields">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control form-control-sm" id="feature_square_access_token" name="square_access_token" placeholder="EAAAl..." autocomplete="new-password">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small">Location ID</label>
                                        <input type="text" class="form-control form-control-sm" id="feature_square_location_id" name="square_location_id" placeholder="Your Square Location ID">
                                    </div>
                            ...
                            <div class="border rounded p-3 mb-3" id="authorizenetSection">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        ...
                                        <small class="text-muted">Cards + eCheck/ACH - <a href="https://www.authorize.net" target="_blank">authorize.net</a></small>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="feature_authorizenet_enabled" name="authorizenet_enabled" style="width: 3em; height: 1.5em;">
                                    </div>
                                </div>
                                <div class="row g-2" id="authorizenetFields">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control form-control-sm" id="feature_authorizenet_signature_key" name="authorizenet_signature_key" placeholder="Your Signature Key" autocomplete="new-password">
                                    </div>
                                    <div class="col-md-6 d-flex align-items-end">
                                        <div class="form-check">
...
@push('scripts')
<script>
var API_BASE = '{{ rtrim(env("API_PUBLIC_URL", "http://localhost:8400/api/v1"), "/") }}';
var featureSettings = {};
var categoriesList = [];
...
function populateHeaderConfig() {
    ...
    setVal('header_site_title', featureSettings.header_site_title || '{{ config('app.name') }}');
