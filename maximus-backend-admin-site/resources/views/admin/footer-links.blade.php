...
<script>
const API_BASE = '{{ rtrim(env("API_PUBLIC_URL", "http://localhost:8400/api/v1"), "/") }}';
...
const defaultFooterLinks = {
    ...
    resources: [
        ...
        { id: 10, label: 'Pet Care Tips', url: '/pet-care', link_type: 'custom', is_active: true, sort_order: 4 }
    ],
    customer_service: [
...
const defaultPages = [
    ...
    { id: 6, title: 'About Us', slug: 'about', page_type: 'custom', footer_section: 'resources', status: 'published', updated_at: '2025-11-10' },
    { id: 7, title: 'Pet Care Tips', slug: 'pet-care', page_type: 'custom', footer_section: 'resources', status: 'published', updated_at: '2025-11-10' }
];
...
const pageContentData = {
    1: { content: '<h2>Shipping Policy</h2><p>We ship to all 50 US states. Standard shipping takes 5-7 business days. Express shipping available for an additional fee.</p>', meta_title: 'Shipping Policy - ' + appName, meta_description: 'Learn about our shipping options and delivery times.' },
    2: { content: '<h2>Return Policy</h2><p>We accept returns within 30 days of purchase. Items must be unused and in original packaging.</p>', meta_title: 'Return Policy - ' + appName, meta_description: 'Our hassle-free return policy explained.' },
    3: { content: '<h2>Privacy Policy</h2><p>Your privacy is important to us. We do not sell or share your personal information with third parties.</p>', meta_title: 'Privacy Policy - ' + appName, meta_description: 'How we protect your personal information.' },
    4: { content: '<h2>Terms of Service</h2><p>By using our website, you agree to these terms of service. Please read them carefully.</p>', meta_title: 'Terms of Service - ' + appName, meta_description: 'Terms and conditions for using our website.' },
    5: { content: '<h2>Sizing Guide</h2><p>Use our comprehensive sizing guide to find the perfect fit for pet supplies and accessories.</p>', meta_title: 'Sizing Guide - ' + appName, meta_description: 'Find the perfect size with our sizing charts.' },
    6: { content: '<h2>About Us</h2><p>We are your trusted destination for premium pet supplies and accessories.</p>', meta_title: 'About Us - ' + appName, meta_description: 'Learn about our company and mission.' },
    7: { content: '<h2>Pet Care Tips</h2><p>Essential tips and guides for taking care of your beloved pets.</p>', meta_title: 'Pet Care Tips - ' + appName, meta_description: 'Helpful tips for pet owners.' }
};
