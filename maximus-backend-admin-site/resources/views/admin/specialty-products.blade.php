...
function getImageUrl(imagePath) {
    ...
    if (imagePath.startsWith('products/')) {
        return `${STOREFRONT_URL}/storage/${imagePath}`;
    }
    return `${STOREFRONT_URL}/assets/${imagePath}`;
}
...
function renderCategoryProducts(products) {
    ...
    products.forEach(product => {
        const imageSrc = product.product_image ? getImageUrl(product.product_image) : NO_IMAGE_PLACEHOLDER;
