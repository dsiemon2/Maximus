    ...
    <div class="col-md-4">
        <div class="card mb-4">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-3"><i class="bi bi-envelope"></i> {{ $adminUser['email'] ?? 'admin@' . str_replace(' ', '', strtolower(config('app.name'))) . '.com' }}</p>
                ...
                <form id="profileForm">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" value="{{ $adminUser['email'] ?? 'admin@' . str_replace(' ', '', strtolower(config('app.name'))) . '.com' }}" readonly>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" value="{{ $adminUser['email'] ?? 'admin@' . str_replace(' ', '', strtolower(config('app.name'))) . '.com' }}">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <input type="text" name="username" value="{{ $adminUser['email'] ?? 'admin@' . str_replace(' ', '', strtolower(config('app.name'))) . '.com' }}" autocomplete="username" class="d-none" aria-hidden="true">
                    <div class="mb-3">
