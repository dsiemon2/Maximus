                ...
                <form id="postForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="postAuthor" name="author_name" placeholder="{{ config('app.name') }} Team">
                        </div>
...
function showExistingImage(imagePath) {
    if (imagePath) {
        document.getElementById('previewImg').src = '/assets/' + imagePath;
        document.getElementById('imagePreview').style.display = 'block';
...
async function savePost() {
    ...
    const formData = {
        ...
        author_name: document.getElementById('postAuthor').value || '{{ config('app.name') }} Team',
