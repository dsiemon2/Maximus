...
function getImageUrl(imagePath) {
    if (!imagePath) return '{{ asset("assets/images/no-image.svg") }}';
    if (imagePath.startsWith('http://') || imagePath.startsWith('https://')) return imagePath;
    return '{{ rtrim(env("STOREFRONT_URL", "http://localhost:8400"), "/") }}/assets/' + imagePath;
}
...
function renderCategories() {
    ...
    featuredCategories.forEach(fc => {
        const imageSrc = getImageUrl(fc.category_image);
