                        ...
                        <form id="brandingForm" class="admin-form" onsubmit="saveBrandingSettings(event)">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <img id="currentLogoPreview" src="{{ rtrim(env('STOREFRONT_URL', 'http://localhost:8400'), '/') }}/assets/images/maximus-logo.png" alt="Current Logo" style="max-height: 60px; background: #333; padding: 5px; border-radius: 4px;">
                                    <span class="text-muted small" id="currentLogoPath">maximus-logo.png</span>
                                </div>
                            </div>
                                ...
                                <div id="headerPreview" class="rounded overflow-hidden position-center" style="background: #8B4513;">
                                    <nav class="d-flex align-items-center px-3 py-2" id="previewNav">
                                        <div id="previewLogoWrapper" style="display: flex; align-items: center;">
                                            <img id="previewLogo" src="{{ rtrim(env('STOREFRONT_URL', 'http://localhost:8400'), '/') }}/assets/images/maximus-logo.png" alt="Logo" style="max-height: 40px;">
                                        </div>
