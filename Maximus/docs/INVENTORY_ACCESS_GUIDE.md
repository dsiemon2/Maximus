...
**Base URL:** http://localhost:8401/adminpanel

#### 1. Purchase Order Management ✅

**Main Page:**
```
http://localhost:8401/adminpanel/purchase-orders
```
...
**Create New PO:**
```
http://localhost:8401/adminpanel/purchase-orders/create
```

**View PO Details:**
```
http://localhost:8401/adminpanel/purchase-orders/{id}
```
Example: `http://localhost:8401/adminpanel/purchase-orders/1`
...
**URL:**
```
http://localhost:8401/adminpanel/inventory/receive
```
...
**Main Inventory Page:**
```
http://localhost:8401/adminpanel/inventory
```
...
**Inventory Reports:**
```
http://localhost:8401/adminpanel/inventory/reports
```
...
**Stock Alerts:**
```
http://localhost:8401/adminpanel/inventory/alerts
```

**Bulk Update:**
```
http://localhost:8401/adminpanel/inventory/bulk-update
```

**Export:**
```
http://localhost:8401/adminpanel/inventory/export
```
...
**Base URL:** http://localhost:8400/prt2

#### 4. Frontend Stock Badges ✅

**Product Listing Page:**
```
http://localhost:8400/prt2/Products/products.php
```
...
**Product Detail Page:**
```
http://localhost:8400/prt2/Products/product-detail.php?id={product_id}
```
...
**Example URLs:**
```
http://localhost:8400/prt2/Products/products.php?CategoryCode=59
http://localhost:8400/prt2/Products/product-detail.php?id=12345
```
...
### Backend Admin (Laravel) - http://localhost:8401/adminpanel
...
### Frontend (PHP) - http://localhost:8400/prt2
...
**Base URL:** http://localhost:8400/api/v1/admin
...
**Backend (Admin):**
1. **Purchase Orders:** http://localhost:8401/adminpanel/purchase-orders
2. **Receiving:** http://localhost:8401/adminpanel/inventory/receive
3. **Inventory:** http://localhost:8401/adminpanel/inventory
4. **Stock Alerts:** http://localhost:8401/adminpanel/inventory/alerts
5. **Reports:** http://localhost:8401/adminpanel/inventory/reports

**Frontend (Customer):**
1. **Products:** http://localhost:8400/prt2/Products/products.php
2. **Cart:** http://localhost:8400/prt2/cart/cart.php
3. **Checkout:** http://localhost:8400/prt2/cart/checkout.php
...
1. **Log in:** http://localhost:8401/login
...
- [ ] **Purchase Orders List** - http://localhost:8401/adminpanel/purchase-orders
  - Can you see the page?
  - Does it load without errors?

- [ ] **Inventory Receiving** - http://localhost:8401/adminpanel/inventory/receive
  - Can you see the barcode scanner?
  - Can you enter UPC codes?

- [ ] **Inventory List** - http://localhost:8401/adminpanel/inventory
  - Can you see stock levels?
  - Do alerts show?

- [ ] **Products Page** - http://localhost:8400/prt2/Products/products.php
  - Do stock badges appear?
  - Are colors correct (green/yellow/red)?

- [ ] **Product Detail** - http://localhost:8400/prt2/Products/product-detail.php?id=1
