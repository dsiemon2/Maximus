...
- Purchase Orders: http://localhost:8401/adminpanel/purchase-orders
- Receive Inventory: http://localhost:8401/adminpanel/inventory-receive
- API Base: http://localhost:8400/api/v1/admin/purchase-orders
