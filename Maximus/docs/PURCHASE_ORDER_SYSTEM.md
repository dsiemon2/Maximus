...
**Base URL**: `http://localhost:8400/api/v1/admin/purchase-orders`
...
**URL**: `http://localhost:8401/admin/purchase-orders`
...
**URL**: `http://localhost:8401/admin/inventory-receive`
...
**Access URLs**:
- Purchase Orders: http://localhost:8401/admin/purchase-orders
- Receive Inventory: http://localhost:8401/admin/inventory-receive
- API: http://localhost:8400/api/v1/admin/purchase-orders
