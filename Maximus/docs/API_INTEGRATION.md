...
Maximus integrates with the Admin API (http://localhost:8400) for dynamic settings and configuration. This guide documents all API endpoints used and how they're consumed in Laravel.
...
curl http://localhost:8400/api/v1/admin/settings

# Test features endpoint
curl http://localhost:8400/api/v1/admin/settings/features

# Test featured categories
curl http://localhost:8400/api/v1/featured-categories

# Test featured products
curl http://localhost:8400/api/v1/featured-products
```
