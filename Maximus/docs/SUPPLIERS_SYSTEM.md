...
| Page | URL |
|------|-----|
| **Suppliers List** | http://localhost:8401/admin/suppliers |
| **Add Supplier** | http://localhost:8401/admin/suppliers/add |
| **Supplier Detail** | http://localhost:8401/admin/suppliers/{id} |
...
1. **Navigate to** http://localhost:8401/admin/suppliers
...
- **Suppliers Page:** http://localhost:8401/admin/suppliers
- **Add Supplier:** http://localhost:8401/admin/suppliers/add
- **API Base:** http://localhost:8400/api/v1/admin/suppliers
