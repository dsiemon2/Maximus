...
class BrandingService
{
    ...
    {
        return [
            'logo_path' => 'assets/images/MaximusLogo.png',
            'logo_alignment' => 'left',
            'site_title' => 'Maximus Pet Store',

            // Header styling - Pet store blue/teal theme
            'bg_color' => '#2E86AB',
            'text_color' => '#FFFFFF',
            'hover_color' => '#F6AE2D',
            'style' => 'gradient',
            ...
            'announcement_text' => 'Free shipping on orders over $49! Auto-Ship & Save 10%',
            'announcement_bg' => '#4CAF50',
            'announcement_text_color' => '#FFFFFF',

            // Theme colors - Pet store friendly colors
            'theme' => [
                'primary' => '#2E86AB',
                'secondary' => '#4CAF50',
                'accent' => '#F6AE2D',
    ...
    public function getThemeCSS(): string
    {
        ...
        // Generate dark variants for better contrast
        $primaryDark = $this->adjustBrightness($theme['primary'], -25);
        $secondaryDark = $this->adjustBrightness($theme['secondary'], -25);
        $accentDark = $this->adjustBrightness($theme['accent'], -25);
...
:root {
    ...
    --theme-bg: {$theme['bg']};
    --theme-header-bg: {$settings['bg_color']};
    --theme-header-text: {$settings['text_color']};
    --theme-header-hover: {$settings['hover_color']};
    /* Legacy aliases */
...
/* Apply theme colors */
.btn-prt, .btn-primary, .btn-theme {
    background-color: var(--theme-primary) !important;
    border-color: var(--theme-primary) !important;
}

.btn-prt:hover, .btn-primary:hover, .btn-theme:hover {
    background-color: var(--theme-secondary) !important;
    border-color: var(--theme-secondary) !important;
}

.text-prt-primary, .text-theme-primary { color: var(--theme-primary) !important; }
.text-prt-secondary, .text-theme-secondary { color: var(--theme-secondary) !important; }
.text-prt-accent, .text-theme-accent { color: var(--theme-accent) !important; }

.bg-prt-primary, .bg-theme-primary { background-color: var(--theme-primary) !important; }
.bg-prt-secondary, .bg-theme-secondary { background-color: var(--theme-secondary) !important; }
.bg-prt-accent, .bg-theme-accent { background-color: var(--theme-accent) !important; }
