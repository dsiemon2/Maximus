...
<div class="container my-4">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <h1 style="color: var(--theme-primary);">Terms of Service</h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p>
                        ...
                        {{ config('app.name') }}'s website for personal, non-commercial transitory viewing only.
                    </p>
                    ...
                    <p>
                        In no event shall {{ config('app.name') }} be liable for any damages arising out of
