...
<div class="container my-4">
    <h1 style="color: var(--theme-primary);"><i class="bi bi-envelope"></i> Contact Us</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p class="mb-1">
                        <a href="mailto:info@{{ str_replace(' ', '', strtolower(config('app.name'))) }}.com">info@{{ str_replace(' ', '', strtolower(config('app.name'))) }}.com</a>
                    </p>
