    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <div class="card shadow">
                <div class="card-header text-center" style="background: var(--theme-primary); color: white;">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email"
                                       ...
                                       value="{{ old('email', 'test@' . str_replace(' ', '', strtolower(config('app.name'))) . '.com') }}"
                                       required
                                       autofocus>
                            </div>
                            @error('email')
            ...
            <div class="text-center mt-4">
                <p class="text-muted small">
                    <i class="bi bi-shield-check" style="color: var(--theme-secondary);"></i>
