...
<nav class="{{ $navbarClasses }}">
    <div class="container-fluid">
        <div class="{{ $brandingService->getLogoWrapperClasses() }}">
            <a href="{{ url('/') }}">
                <img src="{{ asset($brandingSettings['logo_path'] ?? 'assets/images/MaximusLogo.png') }}" alt="{{ $brandingSettings['site_title'] ?? config('app.name') }}" class="navbar-header-image" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">
                <span class="navbar-brand d-none" style="color: var(--theme-header-text, #fff);">{{ $brandingSettings['site_title'] ?? config('app.name') }}</span>
            </a>
        </div>
                ...
                <li class="nav-item dropdown">
                    @auth
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="logout(event); return false;">
