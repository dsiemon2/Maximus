...
<section class="page-header">
    <div class="container text-center">
        <h1 class="display-4 fw-bold mb-3" style="color: var(--theme-primary);">
            <i class="bi bi-calendar-event"></i> Events Calendar
        </h1>
        <p class="lead" style="color: var(--theme-primary);">Stay updated with upcoming pet events at {{ config('app.name') }}</p>
    </div>
</section>
                    ...
                    @foreach($events as $event)
                        ...
                        @if(!$monthPrintFlag)
                            <div class="month-header mb-4 {{ !$loop->first ? 'mt-5' : '' }}">
                                <h2 class="fw-bold" style="color: var(--theme-primary);">
